...
<%-- *******************************Main Body************************************** --%>	
	<div style="float:left">
		<h1 id="h1">Failed ! Logout action can not be processed at this time.</h1>
	</div>	
<%-- *******************************End of Main Body************************************** --%>	
...
<%-- *******************************MENU BAR************************************** --%>
	...
	<div class="navbar navbar-inverse navbar-static-top" id="stickyHeader">
		<a href="javascript:void(0)" class="navbar-brand" id="logo"><img  src="${pageContext.request.contextPath}/resources/images/logo.jpg" width="40px" style="margin-top: -15px"></a>
		
		<div class="container" id="topbar">
			
			<button class="navbar-toggle" data-toggle="collapse" data-target=".navHeaderCollapse" style="margin-right:-125px;">
			...
			<div class="collapse navbar-collapse navHeaderCollapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">Job Network<b class="caret"></b></a>
